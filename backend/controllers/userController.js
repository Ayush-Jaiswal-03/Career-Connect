...
export const register = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    if (!name || !email || !phone || !address || !password || !role) {
      ...
      //creates new error using a custom class and passes it to the next middleware in the stack 
      //ensure you have an error handling middleware 
      //app.use(errorMiddleware) hai app.js mei
    }
